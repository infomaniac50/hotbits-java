...
/**
 * Implementation of a <b>randomX</b>-compliant class using the simple (and not
...
public class randomLCG extends randomX {
	...
	/**
	 * Get next byte from generator. Given how poor this generator is, it's wise
	 * to make a separate call for each byte rather than extract fields from a
	 * single call, which may be correlated. Also, the higher-order bits of this
	 * generator are more random than the low, so we extract the byte after
	 * discarding the low-order 11 bits.
	 * 
